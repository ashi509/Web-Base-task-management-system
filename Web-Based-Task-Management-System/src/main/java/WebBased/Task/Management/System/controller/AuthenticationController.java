...
import WebBased.Task.Management.System.model.AuthResponse;
import WebBased.Task.Management.System.repository.UserRepository;
import WebBased.Task.Management.System.util.JwtUtil;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> generateRefreshToken(@RequestBody Map<String,Optional<String>> refresh) throws GenericException {
        ...
        var user= userRepository.findByEmail(jwtUtil.extractUsername(refreshToken))
